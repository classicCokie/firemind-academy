export default {
  ...
  metaDescription:
    "On some of the Animations you get from the Unity Assetstore, there is a Readonly flag, which prevents you from editing the Animation. This tutorial shows you how to remove it.",
